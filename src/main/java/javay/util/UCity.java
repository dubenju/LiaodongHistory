...
public class UCity {
  ...
  static {
    ...
    modelCities.put("曾迟堡" , new ModelCity("曾迟堡", 123.69812607765199, 42.31363757334767, 0));
    ...
    modelCities.put("▼永宁堡" , new ModelCity("▼永宁堡", 124.0426102280617, 42.75049844661097, 0));
    ...
    modelCities.put("黄骨岛堡" , new ModelCity("黄骨岛堡", 123.25046539306642, 39.746398049658005, 40));
    ...
    modelCities.put("抚顺城" , new ModelCity("抚顺城", 123.91037464141847, 41.88739867209452, 76));
    ...
    modelCities.put("东州堡" , new ModelCity("◇东州堡，1469年，抚顺市抚顺县大东村", 124.01464819908144, 41.7436959778904, 0));
    ...
    modelCities.put("镇朔关" , new ModelCity("镇朔关", 124.52367782592775, 40.88469127861962, 0)); // 凤城市叆阳城
    /* 在爱阳镇爱阳城村北1．5公里疆河南岸明代边墙镇朔关遗址处。*/
    /* 在村中的关帝庙，记者看到一块石制匾额，上刻“叆阳城，成化柒年八月中秋日立”，应是叆阳城门匾。 */
    modelCities.put("靉阳堡" , new ModelCity("☆靉阳堡，1471年，凤城市叆阳镇叆阳城村", 124.51982617378236, 40.90177148128095, 0)); // 凤城市叆阳城
    ...
    modelCities.put("宁东堡" , new ModelCity("☆宁东堡，1546年，凤城市土城子村", 124.39555406570436, 40.361931298271564, 0)); // 凤城市土城子村
    modelCities.put("媳妇山堡" , new ModelCity("媳妇山堡", 124.37444508075716, 40.355246851482846, 0)); // 凤城市土城子村
    modelCities.put("江沿台堡" , new ModelCity("☆江沿台堡，1546年初建张铎增设1565年再建，振安区东城村(水没)", 124.4579315185547, 40.29005078858388, 76)); // 振安区东城村(水没)
     ...
     */
    modelCities.put("■新奠堡" , new ModelCity("长岭■新奠堡，1576年建成，赫甸", 124.6278762817383, 40.74198972871025, 0)); // 今宽甸县青椅山公社赫甸城大队
    modelCities.put("■宽奠堡" , new ModelCity("宽佃子■宽奠堡，宽甸", 124.78250563144685, 40.725776954636316, 0)); // 今宽甸县
    ...
    modelCities.put("■大奠子堡" , new ModelCity("散等■大奠堡，1576年建成，坦甸", 124.79889392852785, 40.62161791497431, 0));
    modelCities.put("■永奠堡" , new ModelCity("双墩儿■永奠堡，1577年建成，永甸", 124.83223378658296, 40.55557643314853, 0));
    modelCities.put("■长奠堡" , new ModelCity("长佃子■长奠堡，1575年建成，长甸", 124.81586694717409, 40.484294349736444, 0));
    modelCities.put("■苏佃子城" , new ModelCity("■苏佃子城，1577年建成，苏甸", 124.78784322738649, 40.43115872093923, 0));
    modelCities.put("■大奠堡" , new ModelCity("■大佃子堡，1576年建成，杨木川土城子村，444名官军", 124.61566150188446, 40.54544741793487, 0)); // 丹东市宽甸满族自治县土城子村，宽甸县杨木川乡土城子村南500米处,东北2米为土城子小学。
    modelCities.put("■镇江堡" , new ModelCity("■镇江堡，九连城", 124.46860671043397, 40.20268198778386, 0));
    ...
    modelCities.put("鸦鹘关" , new ModelCity("鸦鹘关，1468年建成韩斌，新宾三道关村", 124.57301974296571, 41.54229273452309, 0)); // 抚顺市新宾满族自治县三道关村
    ...
    modelCities.put("牛毛寨" , new ModelCity("牛毛寨", 125.17060518264772, 41.322250331342595, 0)); // 本溪市桓仁满族自治县大甸子村
    ...
    modelCities.put("六道河城址" , new ModelCity("六道河城址", 124.52210605144502, 40.74549313611558, 0)); // 位于宽甸县青椅山镇八棵树村六道河南岸的台地上。
    modelCities.put("双岭子土城址" , new ModelCity("双岭子土城址", 124.73040103912355, 40.68713044670614, 0)); // 宽甸县石湖沟乡双岭子村2组与3组交界处的玉米地中
