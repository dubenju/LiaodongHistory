...
public class Zaoqi {
    ...
    public Zaoqi() {
        ...
        DefaultVertex 宣城卫 = new DefaultVertex(UCity.getCity("宣城卫"));
        ...
        DefaultVertex 柏林川村 = new DefaultVertex(UCity.getCity("柏林川村"));
        DefaultVertex 小边沟 = new DefaultVertex(UCity.getCity("小边沟"));
        DefaultVertex 镇朔关 = new DefaultVertex(UCity.getCity("镇朔关"));
        DefaultVertex 二台子烽火台 = new DefaultVertex(UCity.getCity("二台子烽火台"));
        DefaultVertex 三台子烽火台 = new DefaultVertex(UCity.getCity("三台子烽火台"));
        DefaultVertex 长岭烽火台 = new DefaultVertex(UCity.getCity("长岭烽火台"));
        DefaultVertex 三台子小楼烽火台 = new DefaultVertex(UCity.getCity("三台子小楼烽火台"));
        ...
        DefaultVertex 东洲村 = new DefaultVertex(UCity.getCity("东洲村"));
        DefaultVertex 大东村 = new DefaultVertex(UCity.getCity("大东村"));
        DefaultVertex 小东村 = new DefaultVertex(UCity.getCity("小东村"));

        DefaultVertex 辽代古塔 = new DefaultVertex(UCity.getCity("辽代古塔"));
        DefaultVertex 清代观音阁 = new DefaultVertex(UCity.getCity("清代观音阁"));
        DefaultVertex 抚顺城 = new DefaultVertex(UCity.getCity("抚顺城"));
        DefaultVertex 抚顺关 = new DefaultVertex(UCity.getCity("抚顺关"));
        DefaultVertex 王杲山 = new DefaultVertex(UCity.getCity("王杲山"));
        DefaultVertex 萨尔浒 = new DefaultVertex(UCity.getCity("萨尔浒"));
        ...
        DefaultVertex 拉古哨 = new DefaultVertex(UCity.getCity("拉古哨"));
        DefaultVertex 古勒城 = new DefaultVertex(UCity.getCity("古勒城"));
        DefaultVertex 鸦鹘关 = new DefaultVertex(UCity.getCity("鸦鹘关"));
        DefaultVertex 新鸦鹘关 = new DefaultVertex(UCity.getCity("新鸦鹘关"));
        DefaultVertex 扎喀尖 = new DefaultVertex(UCity.getCity("扎喀尖"));
        DefaultVertex 玳珉关 = new DefaultVertex(UCity.getCity("玳珉关"));
        DefaultVertex 雅尔哈关 = new DefaultVertex(UCity.getCity("雅尔哈关"));
        DefaultVertex 札喀关 = new DefaultVertex(UCity.getCity("札喀关"));
        DefaultVertex 建州老寨 = new DefaultVertex(UCity.getCity("建州老寨"));
        DefaultVertex 章甲城 = new DefaultVertex(UCity.getCity("章甲城"));
        DefaultVertex 牛毛寨 = new DefaultVertex(UCity.getCity("牛毛寨"));
        DefaultVertex 亮马佃 = new DefaultVertex(UCity.getCity("亮马佃"));
        DefaultVertex 董古寨 = new DefaultVertex(UCity.getCity("董古寨"));
        DefaultVertex 小雅河村 = new DefaultVertex(UCity.getCity("小雅河村"));
        // DefaultVertex 董古寨 = new DefaultVertex(UCity.getCity("董古寨"));
        DefaultVertex 夹道子村 = new DefaultVertex(UCity.getCity("夹道子村"));
        DefaultVertex 姜家堡土城址 = new DefaultVertex(UCity.getCity("姜家堡土城址"));
        DefaultVertex 双岭子土城址 = new DefaultVertex(UCity.getCity("双岭子土城址"));
        DefaultVertex 蒲石河土城址 = new DefaultVertex(UCity.getCity("蒲石河土城址"));
        DefaultVertex 六道河城址 = new DefaultVertex(UCity.getCity("六道河城址"));

        DefaultVertex 安平城 = new DefaultVertex(UCity.getCity("安平城"));
        DefaultVertex 生铁顶子烽火台 = new DefaultVertex(UCity.getCity("生铁顶子烽火台"));
        DefaultVertex 城东山烽火台 = new DefaultVertex(UCity.getCity("城东山烽火台"));
        DefaultVertex 向阳西山烽火台 = new DefaultVertex(UCity.getCity("向阳西山烽火台"));
        DefaultVertex 长甸东山烽火台 = new DefaultVertex(UCity.getCity("长甸东山烽火台"));
        DefaultVertex 台沟烽火台 = new DefaultVertex(UCity.getCity("台沟烽火台"));
        DefaultVertex 前进烽火台 = new DefaultVertex(UCity.getCity("前进烽火台"));
        DefaultVertex 尖头山烽火台 = new DefaultVertex(UCity.getCity("尖头山烽火台"));
        DefaultVertex 老殷大尧沟山烽火台 = new DefaultVertex(UCity.getCity("老殷大尧沟山烽火台"));
        DefaultVertex 老黄前沟东山烽火台 = new DefaultVertex(UCity.getCity("老黄前沟东山烽火台"));
        DefaultVertex 老付家前山烽火台 = new DefaultVertex(UCity.getCity("老付家前山烽火台"));
        DefaultVertex 白菜地南山烽火台 = new DefaultVertex(UCity.getCity("白菜地南山烽火台"));
        DefaultVertex 贾家堡子烽火台 = new DefaultVertex(UCity.getCity("贾家堡子烽火台"));
...
//        graph.setEdge(老付家前山烽火台, 白菜地南山烽火台, 1);
...
//        graph.setEdge(归服堡, 黄骨岛堡, 1);
      ...
      this.panel = new ViewMapPanel(graph);
      ...
      contentPane.add(this.jsp, BorderLayout.CENTER);
