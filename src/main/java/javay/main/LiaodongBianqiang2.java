...
public class LiaodongBianqiang2 {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                LiaodongBianqiang2 fg = new LiaodongBianqiang2();
            }
        });
    }
    /**
...
//
        ...
        graph.setEdge(靉阳堡, 硷场堡, 1);
        graph.setEdge(硷场堡, 清河堡, 1);
        graph.setEdge(清河堡, 马根单堡, 1);
        graph.setEdge(马根单堡, 东州堡, 1);
        graph.setEdge(东州堡, 抚顺城, 1);
...
//        graph.setEdge(金州卫, 旅顺口城, 1);
//        graph.setEdge(金州卫, 望海埚堡, 1);
//        graph.setEdge(望海埚堡, 红嘴堡, 1);
//        graph.setEdge(红嘴堡, 黄骨岛堡, 1);
